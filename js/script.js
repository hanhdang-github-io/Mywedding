(function ($) {
  $(document).ready(function () {
    ...
    function send_form (type) {
      ...
      $.ajax({
        type: "POST",
        url: "https://docs.google.com/forms/d/e/1FAIpQLScQuK5lzf5urmUQMgdsTT_SWlhJ0LG1ZiTtjd9Ic3WTvkfbjA/viewform",
        data: dataString,
        complete:sent
      });
    }
    ...
    /*CountDown*/
    $('.married_coundown').countdown({until: new Date("June 18, 2022 10:00:00")});
